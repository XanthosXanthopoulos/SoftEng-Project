...
8 | Ταυτοποίηση χρήστη | Ο χρήστης είτε πρόκειτε για πελάτης έιτε για τεχνικός συωδέεται στο σύστημα χρησιμοποιώντας το όνομα χρήστη του και τον κωδικό του.
...
1. Κουμπία επιλογής κατά την εκκίνηση της εφαρμογής όπου θα δείνεται η δυνατότητα στον χρήστη να επιλέξει αν πρόκειται για πελάτης ή για τεχνικός.
2. Μία φόρμα εισαγωγής των στοιχείων του χρήστη για ταυτοποίηση
3. Μια φόρμα για την εισαγωγή των εργασίων καθως και των περιοχών και ωρλων διαθεσιμότητας του τεχνικού κατα την εγγραφή του.
4. Μία λίστα με τους διαθέσιμους τεχνικούς κατόπιν αναζήτησης του πελάτη.
5. Μια φόρμα για την συμπλήρωση των κρητηρίων αναζήτησης για τεχνικό.
6. Μία λίστα με τις ειδοποιήσεις των ραντεβού που λαμβάνει ο τεχνικός. Κάθε στοιχείο της λιστας αυ΄τη θα περιλαμβάνει
...
Για την λειτουργία της η εφαρμογή απαιτεί σύνδεση στο διαδύκτιο για την εύρεση και την δημιουργεία ραντεβού.
...
#### Απόδοση
Το λογισμικό θα πρέπει να είναι σε θέση να τρέχει σε συσκευές με χαμηλές δυνατότητες. Θα πρέπει να επεξεργάζεται και να διαβιβάζει τα δεδομένα και τις ενέργεις του χρήστη σε πραγματικό χρόνο. 
Η παροχή μιας υπηρεσίας από έναν νέο τεχνικό θα πρέπει να είναι άμεση όπως και η ισοποίηση για ένα ραντεβού θα πρέπει να λαμβάνεται άμεσα από τον τεχνικό.

#### Διαθεσιμότητα
Το λογισμικό θα πρέπει να είναι διαθέσιμο για λήψη και εγκατάσταση από το PlayStore. Εναλάκτικά για συσκευές πού δεν το υποστηρίζουν θα μπορεί να γίνει λύψη του από την επίσημη ιστοσελίδα της εφαρμογής στην διεύθυνση 
...
2. Θα πρέπει να έχειτο επίπεδο "Επισκέπτης" όπου δεν απαιτείται εγγραφή και θα μπορεί να αναζητεί τεχνικό χωρίς παρόλα αυτα να μπορεί να κλείσει κάποιο ραντεβού
3. Θα πρέπει να διαθέτει το επίπεδο "Τεχνικος" όπου θα απαιτείται εγγραφή και κάποιος θα μπορεί να περέχει υπηρεσίες προς τους υπόλοιπους χρήστες της εφαρμογής.

Ο χρήστης δεν θα μπορεί να έχει πρόσβαση σε λειτουργίες που απαιτούν εξουσιοδότηση αναώτερη του "Επισκέπτη" αν πρότεινος δεν έχει ταυτοποιηθεί από το σύστημα. Επιπλέον δεν θα πρέπει να αποθηκεύονται τοπικά στην συσκευή κωδικοί του χρήστη καθώς και ευαίσθητα προσωπικά δεδομένα(ΑΦΜ, τραπεζικοί λογαριασμοί, διευθύνσεις).

#### Ευελιξία
*Εδω δεν ξέρω τι να βάλω*

#### Ευχρηστία
Το λογισμικό θα πρέπει να διαθέτει μια εύχρηστη διεπαφή χρήστη με minimal σχεδίαση και σκούρα χρώματα. Τα στοιχεία της διεπαφής θα πρέπει να είναι κατανοητά από χρήστες όλων των ηλικιακών ομάδων. Για την χρήση της εφαρμογής δεν θα πρέπει να είναι απαραίτηση η χρήση manual. Σε κάθε περίπτωση οστώσο θα πρέπει να παρέχετε στο χρήστη βοήθεια σε σηεμία όπου απαιτείται να εκτελέση εκείνος κάποια ενέργεια.