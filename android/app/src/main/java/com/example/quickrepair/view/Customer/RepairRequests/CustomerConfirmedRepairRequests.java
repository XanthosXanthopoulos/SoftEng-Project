...
public class CustomerConfirmedRepairRequests extends Fragment implements ItemSelectionListener<RepairRequest> {
    ...
    public static CustomerConfirmedRepairRequests newInstance() {
        return new CustomerConfirmedRepairRequests();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.customer_confirmed_repair_requests, container, false);
    }
